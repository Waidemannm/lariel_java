...
public class RecadosPendentesResource {
    ...
    private RecadosPendetesBO recadosPendetesBO = new RecadosPendetesBO();
    ...
    public Response save(@Valid RecadosPendentesTO recadosPendentesTO, @RestForm String nomeConvidados,
